    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="px-4 py-2.5 bg-zinc-800 hover:bg-zinc-700 text-white font-bold text-xs rounded-lg transition border border-zinc-700 flex items-center justify-center gap-2 cursor-pointer"
        >
      ...
      {/* Banner Explicativo Arquitetural (KISS e Baixo Acoplamento) */}
      <div className="p-4 rounded-xl bg-blue-950/30 border border-blue-500/20 flex items-start gap-3 text-xs">
        ...
        <div className="space-y-1">
          ...
          <p className="text-zinc-300 leading-relaxed">
            O núcleo do MartialCore (presenças, autenticação, financeiro e cadastros) não conhece regras particulares de nenhuma luta. Quando o usuário seleciona uma arte marcial, os metadados abaixo são injetados em tempo de execução para customizar a interface, carências e formulários técnicos.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-2">
          <span className="text-xs font-mono uppercase text-zinc-400 font-bold block px-1">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-zinc-400 mt-0.5">{m.graduationType}</p>
                    </div>
                  </div>
        ...
        <div className="lg:col-span-2 p-6 rounded-xl bg-zinc-900/80 border border-zinc-800 space-y-6">
          <div className="flex items-center justify-between pb-4 border-b border-zinc-800">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-black text-white text-lg">{selectedModality.name}</h3>
                <p className="text-xs text-zinc-400">{selectedModality.tagline}</p>
              </div>
            </div>

            <span className="text-xs font-mono px-2.5 py-1 rounded bg-zinc-800 text-amber-400 border border-zinc-700">
          ...
          <form onSubmit={handleUpdate} className="space-y-4 text-xs">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-zinc-300 font-semibold mb-1">Cor Temática de Destaque</label>
            ...
            <div className="pt-2 flex justify-end">
              <button
                type="submit"
                className="px-4 py-2 bg-amber-500 hover:bg-amber-400 text-black font-bold rounded-lg text-xs transition shadow cursor-pointer"
              >
